...
const PaymentCompsNavbar = () => {
  ...
  return (
    ...
    >
      <nav className="bg-navbar pt-5 px-4 pb-4 rounded-b-2xl m-0 text-white mx-auto z-50 relative h-36">
        ...
        <div className="flex justify-start mt-14  items-center">
          <button
            className="bg-primary h-9 w-9 rounded shadow-lg"
            onClick={() => navigate("/")}
          >
...
export default PaymentCompsNavbar;
